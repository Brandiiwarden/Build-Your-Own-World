...
public class Engine {
    ...
    public static String readUserMovements(String input) { //returns key movement letters for string input
        String[] inputs = input.split("(?<=\\D)(?=\\d)|(?<=\\d)(?=\\D)");
        return inputs[2];
    }
            ...
            if (StdDraw.hasNextKeyTyped()) {
                ...
                if (currentChar == 's') {
                    if (seed.length() > 0) {
                        ...
                        StdDraw.text(40, 15, "Please enter a seed");
                        StdDraw.show();
                        StdDraw.setPenColor(StdDraw.WHITE);
                    }
                }
    ...
    public static void showInstructions() {
        ...
        StdDraw.text(WIDTH / 2, HEIGHT - 21, "Encountering teleportation tiles (▢) let you move across the world using 1 move");
        StdDraw.text(WIDTH / 2, HEIGHT - 23, "Encountering 2 red black holes (█) will cause sudden death");
    ...
    public static void keyboardLoadWorld() {
        ...
        coinsLeft = loadGame.coins;
        Items.numCoins = loadGame.coins;
    ...
    public static void saveWorld(TETile[][] tiles) {
        ...
        while (!saved) {
            try {
                ...
                int coins = Encounters.coinsLeft();

                Memory game = new Memory(tiles, p, avatarName, finishedTypingName, chosenAvatar, coins);
    ...
    public static void keyboardStartGame(TETile[][] tiles, Player player) {
        ...
        while (coinsLeft > 0) {
            ...
            coinsLeft = Encounters.coinsLeft(); //becomes 0?
    ...
    public static void addNameToHUD() {
        ...
        StdDraw.setFont(tileTitle);
        StdDraw.setPenColor(StdDraw.BLACK);
        StdDraw.filledRectangle(40, 39, 19, 0.5);
        StdDraw.setPenColor(StdDraw.RED);
