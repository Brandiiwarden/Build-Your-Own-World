...
public class Encounters {
    ...
    public static void checkTile(String description, TETile[][] tiles) {
        if (description.equals("water")) {
            ...
            StdDraw.filledRectangle(40, 2, 10, 0.5);
        ...
        } else if (description.equals("black hole") && !suddenDeath) {
            Font tileTitle = new Font(Font.MONOSPACED, Font.BOLD, 17);
            StdDraw.setFont(tileTitle);
            StdDraw.setPenColor(StdDraw.BLACK);
            StdDraw.filledRectangle(40, 2, 20, 0.5);
            StdDraw.setPenColor(StdDraw.RED);
            StdDraw.text(40, 2, "You encountered a black hole! Avoid them from now on or else!");
            StdDraw.show();
            suddenDeath = true;
            ...
            StdDraw.setFont(tileTitle);
            StdDraw.setPenColor(StdDraw.BLACK);
            StdDraw.filledRectangle(40, 2, 26, 0.5);
            StdDraw.setPenColor(StdDraw.RED);
    ...
    public static boolean blackHoleLoss() {
        return blackHoleLoss;
    }
