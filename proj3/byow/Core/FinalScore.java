...
public class FinalScore {
    ...
    private static boolean blackHoleLoss = false;


    public static void winOrLose() {
        if (Encounters.blackHoleLoss()) {
            youLostBlackHole();
        } else {
            finalScore();
        }
    ...
    public static void youWon() {
        ...
        StdDraw.text(80 / 2, 40 - 10, "You scored within 80 points of the maximum points you could have received.");
        StdDraw.picture(80 / 2, 40 / 2, "byow/Core/smile.jpg");
        StdDraw.show();
    ...
    public static void youLost() {
        ...
        StdDraw.text(80 / 2, 40 - 10, "You scored over 80 points below the maximum points you could have received.");
        StdDraw.picture(80 / 2, 40 / 2, "byow/Core/frown.png");
        StdDraw.show();

    }

    public static void youLostBlackHole() {
        StdDraw.clear(StdDraw.BLACK);
        StdDraw.setXscale(0.0, 80);
        StdDraw.setYscale(0.0, 40);
        Font water = new Font("Arial", Font.BOLD, 30);
        ...
        StdDraw.setPenColor(StdDraw.WHITE);
        StdDraw.text(80 / 2, 40 - 5, "You lost.");
        StdDraw.text(80 / 2, 40 - 10, "You encountered 2 black holes and got sudden death.");
        StdDraw.picture(80 / 2, 40 / 2, "byow/Core/frown.png");
        StdDraw.show();
